...
set ::env(VERILOG_FILES_BLACKBOX) "\
	$::env(CARAVEL_ROOT)/verilog/rtl/defines.v \
	$::env(DESIGN_DIR)/../../verilog/rtl/C_DP.v \
	$::env(DESIGN_DIR)/../../verilog/rtl/C_FSMR.v \
	$::env(DESIGN_DIR)/../../verilog/rtl/collatz.v"

set ::env(EXTRA_LEFS) "\
	$::env(DESIGN_DIR)/../../lef/collatz.lef"

set ::env(EXTRA_GDS_FILES) "\
	$::env(DESIGN_DIR)/../../gds/collatz.gds"
